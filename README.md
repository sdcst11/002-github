...
Pick a social media or other messaging/media platform that you use (or maybe one that you don't use if you can't find one) and see if it supports Markup Language. Complete the Google Doc attached to your Google Classroom assignment.
